...
elaborate()
{
  xelab --relax --debug typical --mt auto -L xil_defaultlib -L xlslice_v1_0_2 -L xlconstant_v1_1_7 -L unisims_ver -L unimacro_ver -L secureip --snapshot mips xil_defaultlib.mips xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim mips -key {Behavioral:sim_1:Functional:mips} -tclbatch cmd.tcl -protoinst "protoinst_files/mips.protoinst" -log simulate.log
}
...
map_local_libs()
{
  ...
  local_libs=(xlslice_v1_0_2 xlconstant_v1_1_7)
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb mips.wdb xsim.dir)
